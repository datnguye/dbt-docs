...
**Keeping dbdocs safe and secure for everyone**

We take the security of dbdocs seriously and appreciate your help in keeping our community safe.
...
We maintain security updates only for the latest version of dbdocs:
...
**We appreciate responsible disclosure of security vulnerabilities.** Your efforts help keep the dbdocs community safe.

### 🔐 Private Reporting (Recommended)

The most secure way to report vulnerabilities is through GitHub's private vulnerability reporting system:

1. **Navigate to**: [Report Security Vulnerability](https://github.com/datnguye/dbt-docs/security/advisories/new)
...
- **Security Advisory**: [Create New Advisory](https://github.com/datnguye/dbt-docs/security/advisories/new/?title=[SEC])
...
- ✅ Always install from official sources (PyPI: `pip install dbdocs`)
- ✅ Keep dbdocs updated to the latest version
- ✅ Regularly update dependencies: `pip install artifact-parser dbterd --upgrade`
...
**Runtime Security:**
- 🛡️ Run dbdocs in secure, isolated environments
...
- **GitHub Security**: [Security Tab](https://github.com/datnguye/dbt-docs/security)
- **Community**: [Discussions](https://github.com/datnguye/dbt-docs/discussions)

**For Non-Security Issues:**
- 🐛 [Bug Reports](https://github.com/datnguye/dbt-docs/issues)
- 💡 [Feature Requests](https://github.com/datnguye/dbt-docs/discussions)
- 📖 [Documentation](https://dbdocs.datnguye.me/)
...
*Thank you for helping keep dbdocs secure for everyone!*

---

**Last Updated**: June 2026 | **Policy Version**: 2.0
